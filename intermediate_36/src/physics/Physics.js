...
export default class Physics {
  ...
  add3Cylinder(object, mass, upperRadius, lowerRadius, height, segments,
              offsetX = 0, offsetY = 0, offsetZ = 0,
              eulerX = 0, eulerY = 0, eulerZ = 0,
              sleeping = false) {
    ...
    body.addShape(new CANNON.Cylinder(upperRadius = 8.5, lowerRadius = 8.5, height = 0.5, segments = 16), offset3, rotation);
    body.addShape(new CANNON.Box(dimension), offsetBox);
